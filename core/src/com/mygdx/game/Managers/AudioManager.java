...
public class AudioManager {
    ...
    public AudioManager() {
        ...
        //backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal(GameResources.BACKGROUND_MUSIC_PATH)); музыку я не проверял на практике так как не нашёл подходящую
